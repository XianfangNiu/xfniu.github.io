---
title: "我的第一篇AI教育文章"title: "我的第一篇AI教育文章"
date: 2025-12-24
categories: AI教育
tags: 教育投资, AI重构教育
---
...
选择在GitHub发文，源于一个简单的诉求：国内少有能承载深度行业分析的平台。今天是12月24日，从这一刻起，我会持续更新内容——核心目标只有一个：选择在GitHub发文，源于一个简单的诉求：国内少有能承载深度行业分析的平台。今天是12月24日，从这一刻起，我会持续更新内容——核心目标只有一个：**给有志于用AI重做教育的产品技术人，完整描绘中国在线教育的全场景图谱**，一起去参与到AI服务教育的这把火。，一起去参与到AI服务教育的这把火。
...
全生命周期的教育，必然存在共通的底层逻辑。若抓不住这份共性，全生命周期的教育，必然存在共通的底层逻辑。若抓不住这份共性，**所谓的「重构教育场景」不过是空中楼阁**。。

如今的教育行业，最大的问题在于如今的教育行业，最大的问题在于**过度碎片化**——我们从未站在真实用户的视角，思考过他们的多元需求。互联网产品人都懂：没有哪个成功的产品是纯垂直割裂的。就像视频平台，只会分频道，不会为综艺单独做一个APP、为纪录片再做一个APP……——我们从未站在真实用户的视角，思考过他们的多元需求。互联网产品人都懂：没有哪个成功的产品是纯垂直割裂的。就像视频平台，只会分频道，不会为综艺单独做一个APP、为纪录片再做一个APP……
